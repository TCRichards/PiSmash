...
# this function is modified from experiencor's yolov3-keras library. These args are the same as in config.json.
...
# class used to load .weights file
class WeightReader:
...
# class used to define the corners of some bounding box in the context of
# the associated input img shape and class probs
class BoundBox:
...
# correct the sizes of the bounding boxes for the img shape
