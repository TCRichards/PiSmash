'''
OpenCV's text recognition seems way too unreliable for this project. I'm going to go with Google Vision's API instead
...
def loadImage(path, min_confidence=0.6):
	...
	(newW, newH) = (640, 640)	# Dimensions must be a multiple of 32
	rW = origW / float(newW)
	rH = origH / float(newH)
	...
	for (startX, startY, endX, endY) in boxes:
		...
		# apply padding to each side of the bounding box, respective1ly
